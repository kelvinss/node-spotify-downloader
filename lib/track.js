...
(function() {
  ...
  Track = (function() {
    ...
    Track.prototype.cleanDirs = function() {
      fs.stat(this.file.path, (function(_this) {
        return function(err, stats) {
          if (!err) {
            return fs.unlink(_this.file.path);
          }
        };
      })(this));
      return fs.stat(this.file.path + ".jpg", (function(_this) {
        return function(err, stats) {
          if (!err) {
            return fs.unlink(_this.file.path + ".jpg");
          }
        };
      })(this));
    };
