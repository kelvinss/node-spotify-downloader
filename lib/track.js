...
(function() {
  var AlreadyDownloadedError, EventEmitter, Logger, Path, Track, async, clone, deepMap, domain, fixPathPiece, fs, getSpotID, id3, mkdirp, objTypeof, process, ref, removeFile, request, sformat,
  ...
  ref = require("./util"), removeFile = ref.removeFile, objTypeof = ref.objTypeof, deepMap = ref.deepMap, fixPathPiece = ref.fixPathPiece, getSpotID = ref.getSpotID;
  ...
  Track = (function() {
    ...
    Track.prototype.process = function() {
      ...
      return this.constructor.spotify.get(this.uri, (function(_this) {
        return function(err, track) {
          ...
          try {
            Logger.Log("Downloading: " + _this.track.artist[0].name + " - " + _this.track.name, 1);
            return _this.handle();
          } catch (error) {
            err = error;
    ...
    Track.prototype.formatPath = function(callback) {
      var _path, err, error, fields, fixStrg, i, len, o, pathFormat, ref1, ref2, ref3, trackCopy;
    ...
    Track.prototype.handleFs = function(callback) {
      var stats;
    ...
    Track.prototype.cleanDirs = function(callback) {
      return async.map([this.file.path, this.file.path + ".jpg"], removeFile, callback);
    };

    Track.prototype.downloadCover = function(callback) {
    ...
    Track.prototype.downloadFile = function(_callback) {
      var callback, func, retries, retryTime;
      retries = 2;
      retryTime = 10000;
    ...
    Track.prototype.writeMetadata = function(callback, hasCover) {
      var meta;
      meta = {
