...
(function() {
  var Logger, Path, Track, async, clone, deepMap, domain, fixPathPiece, fs, getSpotID, id3, mkdirp, objTypeof, process, ref, request, sformat,
  ...
  ref = require("./util"), objTypeof = ref.objTypeof, deepMap = ref.deepMap, fixPathPiece = ref.fixPathPiece, getSpotID = ref.getSpotID;
